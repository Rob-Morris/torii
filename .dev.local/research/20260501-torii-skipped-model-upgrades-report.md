...
The diagnostic instrumentation used during the investigation to capture the trigger payload is not part of the runtime fix — see [Patched replay → Diagnostic instrumentation](./20260430-torii-skipped-model-upgrades.md#diagnostic-instrumentation) in the research doc for the full diffs.
...
For implementation detail, evidence, and procedures, see the companion research doc [`20260430-torii-skipped-model-upgrades.md`](./20260430-torii-skipped-model-upgrades.md):

- **[Research brief](./20260430-torii-skipped-model-upgrades.md#research-brief)** — what was known going into the investigation
- **[Root cause walk-through](./20260430-torii-skipped-model-upgrades.md#root-cause-walk-through)** — line-by-line code trace of the rollback/cache poison mechanism
- **[When the bug was introduced / made visible](./20260430-torii-skipped-model-upgrades.md#when-the-bug-was-introduced--made-visible)** — origin in the dojo monorepo, earliest tagged release, and what changed in v1.8.x
- **[Trigger investigation](./20260430-torii-skipped-model-upgrades.md#trigger-investigation-invalidenumselector--actual_selector-18-)** — task/dependency mechanism, supporting code paths, world-event chain reads
- **[Patched replay: trigger captured and fix confirmed](./20260430-torii-skipped-model-upgrades.md#patched-replay-trigger-captured-and-fix-confirmed)** — captured trigger log, chain follow-up, the four-part patch, and the validation replay
- **[Repairing a poisoned DB](./20260430-torii-skipped-model-upgrades.md#repairing-a-poisoned-db)** — manual SQL recovery procedure for an already-poisoned DB
- **[Pistols-side mitigations until upstream is fixed](./20260430-torii-skipped-model-upgrades.md#pistols-side-mitigations-until-upstream-is-fixed)** — operator workarounds and redeploy plan
- **[Reference timeline](./20260430-torii-skipped-model-upgrades.md#reference-timeline)** — chronological reconstruction across torii, Pistols code, deploys, and chain state
- **[Appendix A — Source material](./20260430-torii-skipped-model-upgrades.md#appendix-a--source-material)** — Discord pastes, log captures, and config files the investigation entered with (`S1`–`S10`)
- **[Appendix B — Investigation branches ruled out](./20260430-torii-skipped-model-upgrades.md#appendix-b--investigation-branches-ruled-out)** — eight theories considered during the investigation and the evidence that closed them off (`R1`–`R8`)
- **[Appendix C — Alternative and rejected fix approaches](./20260430-torii-skipped-model-upgrades.md#appendix-c--alternative-and-rejected-fix-approaches)** — eight fix directions considered but not chosen, including open hardening directions and explicit "do not do this" callouts (`F1`–`F8`)
